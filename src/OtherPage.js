...
const OtherPage = () => {
  ...
  useEffect(() => {
    // Fetch the data for Other issues when this page is mounted
    fetch('http://localhost:8080/maintenance/getByIssueType/other')
  ...
  return (
    <div className="page-container">
      ...
      {maintenanceData.length === 0 ? (
        <p className="no-data">No maintenance records available for Other.</p>
      ) : (
