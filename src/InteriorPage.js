...
const InteriorPage = () => {
  ...
  useEffect(() => {
    // Fetch the data for Interior issues when this page is mounted
    fetch('http://localhost:8080/maintenance/getByIssueType/interior')
  ...
  return (
    <div className="page-container">
      <h2>Interior Issues</h2>
      {maintenanceData.length === 0 ? (
        <p className="no-data">No maintenance records available for Interior.</p>
      ) : (
